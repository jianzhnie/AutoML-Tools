...
from search_space import cls_space, reg_space
from functools import partial


def ClsObjective(params, trainData, testData, evaluator):
    """
    ...
    if model_type == 'decision_tree':
        ...
        estimator = GBTClassifier(**params)
    else:
...
def RegObjective(params, trainData, testData, evaluator):
    """
    This is our main training function which we pass to Hyperopt.
    It takes in hyperparameter settings, fits a model based on those settings,
    evaluates the model, and returns the loss.
